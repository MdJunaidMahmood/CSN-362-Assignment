...
1) Input String must consist of only two characters a and b, as alphabet of the language is {a, b}. In case of any other character being present, the string would be considered invalid.
